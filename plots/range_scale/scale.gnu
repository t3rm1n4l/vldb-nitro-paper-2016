...
set xlabel 'Number of rows per request'
set ylabel 'Throughput (rows/s)'
set tics scale 0.8

plot 'scalability.dat' using 1:2 with linespoints ls 1 title 'Range rows/sec'
